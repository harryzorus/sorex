...
### Substring Queries (Sorex Advantage)

**Query: `land`**

| Library | Latency (us) | ops/sec | Results |
|---------|--------------|---------|---------|
| Sorex | 62.2 | 16,066 | 10 |
...
|---------|---------|------------|----------|----------|
| Sorex (streaming) | 30 | 10.1 | 108.0 | 213.2 |
...
| Library | Results | First (us) | All (us) | P99 (us) |
|---------|---------|------------|----------|----------|
| Sorex (streaming) | 18 | 0.6 | 68.6 | 176.8 |
...
| Library | Results | First (us) | All (us) | P99 (us) |
|---------|---------|------------|----------|----------|
| Sorex (streaming) | 8 | 0.4 | 43.5 | 58.8 |
...
|---------|----------|--------------|-------|
| Raw Data | 23.4 | 6.5 |  |
| Sorex (.sorex) | 347.1 | 167.6 | binary |
...
1. **Time to First Search**: Sorex loads pre-built indexes instantly (~Xms). JS libraries must build at runtime.
2. **Substring Search**: Sorex finds results for substring queries where inverted indexes return 0.
3. **Typo Tolerance**: Sorex uses Levenshtein automata for true edit-distance fuzzy matching.
4. **Index Size**: Sorex's binary format is compact and compresses well.
